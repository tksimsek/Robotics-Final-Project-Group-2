...
(cl:defmethod cl:initialize-instance :after ((m <DetectedObject>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DetectedObject)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name locobot_simulation-msg:<DetectedObject> is deprecated: use locobot_simulation-msg:DetectedObject instead.")))
...
(cl:defmethod label-val ((m <DetectedObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader locobot_simulation-msg:label-val is deprecated.  Use locobot_simulation-msg:label instead.")
  (label m))

(cl:ensure-generic-function 'probability-val :lambda-list '(m))
(cl:defmethod probability-val ((m <DetectedObject>))
...
(cl:defmethod bbox-val ((m <DetectedObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader locobot_simulation-msg:bbox-val is deprecated.  Use locobot_simulation-msg:bbox instead.")
  (bbox m))
...
(cl:defmethod position-val ((m <DetectedObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader locobot_simulation-msg:position-val is deprecated.  Use locobot_simulation-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'num_points-val :lambda-list '(m))
(cl:defmethod num_points-val ((m <DetectedObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader locobot_simulation-msg:num_points-val is deprecated.  Use locobot_simulation-msg:num_points instead.")
  (num_points m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DetectedObject>)))
  ...
  "locobot_simulation/DetectedObject")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DetectedObject)))
  "Returns string type for a message object of type 'DetectedObject"
  "locobot_simulation/DetectedObject")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DetectedObject>)))
  ...
  "24b1559ff07fbef77b52a17ccdb9e43a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DetectedObject)))
  "Returns md5sum for a message object of type 'DetectedObject"
  "24b1559ff07fbef77b52a17ccdb9e43a")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DetectedObject>)))
  ...
  (cl:format cl:nil "string name~%string label~%float64 probability~%int64[] bbox~%std_msgs/ColorRGBA color~%geometry_msgs/Point position~%int32 num_points~%================================================================================~%MSG: std_msgs/ColorRGBA~%float32 r~%float32 g~%float32 b~%float32 a~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DetectedObject)))
  "Returns full string definition for message of type 'DetectedObject"
  (cl:format cl:nil "string name~%string label~%float64 probability~%int64[] bbox~%std_msgs/ColorRGBA color~%geometry_msgs/Point position~%int32 num_points~%================================================================================~%MSG: std_msgs/ColorRGBA~%float32 r~%float32 g~%float32 b~%float32 a~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
