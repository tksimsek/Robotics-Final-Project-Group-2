...
"""autogenerated by genpy from locobot_simulation/LogicalImage.msg. Do not edit."""
import codecs
import sys
...
class LogicalImage(genpy.Message):
  _md5sum = "ce67e5d7268d09846f46b13669044ed7"
  _type = "locobot_simulation/LogicalImage"
...
float64 y
float64 z"""
  __slots__ = ['header','models','pose']
  _slot_types = ['std_msgs/Header','locobot_simulation/Model[]','geometry_msgs/Pose']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = locobot_simulation.msg.Model()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
