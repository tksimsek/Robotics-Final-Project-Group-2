...
"""autogenerated by genpy from locobot_simulation/BoundingBoxes.msg. Do not edit."""
import codecs
import sys
...
class BoundingBoxes(genpy.Message):
  ...
  _type = "locobot_simulation/BoundingBoxes"
...
string Class"""
  ...
  _slot_types = ['std_msgs/Header','std_msgs/Header','locobot_simulation/BoundingBox[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = locobot_simulation.msg.BoundingBox()
        _x = val1
        start = end
        end += 42
